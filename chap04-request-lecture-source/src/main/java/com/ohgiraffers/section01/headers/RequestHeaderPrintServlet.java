...
public class RequestHeaderPrintServlet extends HttpServlet {
    ...
    /* 필기
        ...
        2. Request Header - 조회 될 리소스나(정보) 나 클라이언트 자체에 대한 상세 정보를 포함.
        3. Response Header - 응답에 대한 부가적인 정보를 갖고 있는 헤더
        4. Entity Header - 컨텐츠 길이, MINE 타입과 같은 바디에 대한 상세 정보를 포함한다.
     */
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        // 쉽게 설명하면, 나는 출력 된 값들만 accept. 즉, 수용할 수 있어 라는 것과 같음 -> json -> 나는 json 파일을 받을거야
